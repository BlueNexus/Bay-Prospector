 ...
 **/
	...
	proc/getdeptaccess(var/dept)
		...
		if(dept == "Medical")
			deptaccess = list(access_deptguard, access_security, access_sec_doors, access_court, access_maint_tunnels, access_medical, access_morgue, access_surgery, access_chemistry, access_virology, access_genetics)
		if(dept == "Engineering")
			deptaccess = list(access_deptguard, access_security, access_sec_doors, access_court, access_maint_tunnels, access_engine, access_engine_equip, access_tech_storage, access_external_airlocks, access_construction, access_atmospherics)
		if(dept == "Research")
			deptaccess = list(access_deptguard, access_security, access_sec_doors, access_court, access_maint_tunnels, access_tox, access_morgue, access_tox_storage, access_teleporter, access_research, access_robotics, access_xenobiology,access_xenoarch)
		return deptaccess
